...
export default function CreateUser() {
    ...
    useEffect(() => {
        axios.get('http://127.0.0.1:5000/mercadorias')
            .then(response => {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://127.0.0.1:5000/entradas', inputs)
                    ...
                    <div className="col-8">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-3">
                                ...
                                <select className="form-control" name="mercadoria_id" onChange={handleChange}>
